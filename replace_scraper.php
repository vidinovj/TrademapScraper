<?php
// replace_scraper.php - Completely replace the current TrademapScraper.php with clean version

echo "🔄 Replacing TrademapScraper.php with clean version\n";
echo "=================================================\n\n";
...
if (file_exists($scraperPath)) {
    $backupPath = $scraperPath . '.backup.' . date('Y-m-d-H-i-s');
    copy($scraperPath, $backupPath);
    echo "✅ Backed up current version to: " . basename($backupPath) . "\n";
}

// Clean version without ANY debug code
$cleanScraperCode = '<?php
...
file_put_contents($scraperPath, $cleanScraperCode);
echo "✅ Replaced TrademapScraper.php with clean version\n";

echo "\n🧪 Now test the Laravel command:\n";
